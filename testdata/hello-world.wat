(module
  ...
  (import "wasi_snapshot_preview1" "clock_time_get" (func $runtime.clock_time_get (type 7)))
  ...
  (func $write (type 8) (param i32 i32 i32) (result i32)
    ...
    i32.store
    i32.const 0)
  (func $__wasi_fd_write (type 2) (param i32 i32 i32 i32) (result i32)
    (local i32)
    global.get 1
    i32.const 2
    i32.eq
  ...
  (func $runtime.hashmapSet (type 9) (param i32 i32 i32 i32)
    ...
    i32.add
    i32.store)
  (func $runtime.stringToBytes (type 3) (param i32 i32) (result i32)
    ...
    i32.store
    i32.const 0)
  (func $_os.unixFileHandle_.Write (type 10) (param i32 i32 i32)
    (local i32 i32 i32)
    global.get 1
    i32.const 2
    i32.eq
  ...
  (data $.rodata (i32.const 65536) "stack overflowfile already existsfile does not existfree: invalid pointer\00\00\00\00\00\00\004\00\01\00\15\00\00\00realloc: invalid pointerX\00\01\00\18\00\00\00out of memorytype assert failedpanic: panic: runtime error: nil pointer dereferenceindex out of rangeslice out of rangeunreachable\00\00\00\00\00\00\ef\00\01\00\0b\00\00\00deadlocked: no event source/dev/stdoutwriteThis log shows up as DEBUG level!Hello world!")
  (data $.data (i32.const 65888) "x\9c\19\f6\cc\01\01\00\00\00\00\00\98\02\01\00\c1\82\01\00\00\00\00\00\04\00\00\00\0c\00\00\00\01\00\00\00\00\00\00\00\02\00\00\00\00\00\00\00\03\00\00\00\98\00\00\00\01\00\00\00#\01\01\00\0b\00\00\00\00\00\00\00\0e\00\01\00\13\00\00\00!\00\01\00\13"))
